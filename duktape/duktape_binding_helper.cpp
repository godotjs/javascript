...
Error DuktapeBindingHelper::make_ecma_object_for_godot_object(const ECMAScriptGCHandler & p_prototype, Object * p_object, ECMAScriptGCHandler &r_handler) {
